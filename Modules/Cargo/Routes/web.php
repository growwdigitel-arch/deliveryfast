...
use Modules\Cargo\Http\Controllers\DashboardController;
...
if (\Illuminate\Support\Facades\Schema::hasTable('translations') && check_module('localization')) {
    Route::group(
        ...
        Route::get('shipments/ajax-validate-tracking', 'ShipmentController@ajaxValidateTracking')->name('shipments.ajax-validate');
