                ...
                <tr>
                    <td width="60%" valign="top">
                        <div style="margin-bottom: 10px;">
                            ...
                            <span style="font-weight: 800; font-size: 13px; margin-left: 5px;">
                                @if($shipment->payment_type == Modules\Cargo\Entities\Shipment::POSTPAID) POSTPAID @else PREPAID @endif
                        ...
                        <div style="margin-bottom: 10px;">
                            ...
                            <span style="font-weight: 900; font-size: 18px; color: #2563eb; margin-left: 5px;">
...
<div class="no-print" style="text-align: center; margin-top: 20px;">
    <button onclick="window.print()" style="padding: 10px 20px; background: #2563eb; color: #fff; border: none; border-radius: 8px; font-weight: 700; cursor: pointer;">Print Label</button>
</div>
